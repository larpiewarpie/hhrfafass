    ...
    function animate() {
      ...
      particles.forEach((particle) => {
        ...
        const nearbyParticles = particles.filter((otherParticle, index) => {
          if (index <= particles.indexOf(particle)) return false
          const dx = particle.x - otherParticle.x
          const dy = particle.y - otherParticle.y
          return dx * dx + dy * dy < 150 * 150 // Use squared distance to avoid sqrt
        })
        ...
        nearbyParticles.forEach((otherParticle) => {
          ...
          ctx.beginPath()
          ctx.strokeStyle = `rgba(135, 206, 250, ${0.1 * (1 - distance / 150)})`
          ctx.lineWidth = 0.5
